...
gcc -g -O3 -Wall -Wextra -Wpedantic -fsanitize=undefined -I./ -o xoshiro-test xoshiro-test.c xoshiro512starstar.c
*/
...
const char *argp_program_version = "xoshiro-test 1.0";
const char *argp_program_bug_address = "<hladky.jiri@gmail.com>";
static char doc[] = "Test xoshiro512starstar";
